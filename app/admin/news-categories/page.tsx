...
import { Search, Tag, Plus, Edit2, Trash2, Eye, EyeOff } from "lucide-react";
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Quản lý danh mục cho tin tức và bài viết</p>
      </div>
      ...
      <div className="mb-6 flex gap-4 flex-wrap">
        ...
        <button
          onClick={() => router.push('/admin/news-categories/new')}
                ...
                <tr key={category._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        onClick={() => router.push(`/admin/news-categories/${category._id}`)}
