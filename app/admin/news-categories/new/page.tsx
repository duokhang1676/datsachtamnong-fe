...
export default function NewNewsCategoryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Đã thêm danh mục tin tức mới thành công!");
  ...
  return (
    <div>
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Thêm danh mục tin tức</h1>
          <p className="text-gray-600 mt-1">Tạo danh mục tin tức mới</p>
        </div>
      </div>
